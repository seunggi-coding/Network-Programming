...
unpacked_ipheader = Iphdr.unpack_Iphdr(packed_iphdr)
print(unpacked_ipheader)
# unpack된 IP 헤더 정보를 사용하여 패킷 크기, 프로토콜 ID, 출발지 및 목적지 IP 주소를 출력합니다.
print('Packed size: {} Protocol: {} IP: {}'.format(Iphdr.getPacketSize(unpacked_ipheader), Iphdr.getProtocolId(unpacked_ipheader), Iphdr.getIP(unpacked_ipheader)))
